...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.odellya.application'), $a, array('identifier' => 'id', 'indexName' => 'odellya', 'typeName' => 'Application'), NULL));
        $b->addEventListener(array(0 => 'postPersist'), $this->get('main.doctrine.contact_listener'));
        $b->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        $b->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.odellya.contact'), $a, array('identifier' => 'id', 'indexName' => 'odellya', 'typeName' => 'Contact'), NULL));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'bambou', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f13a3d9def4a22407f1f035c8186f5115ea3241c04096f799e6f0a8691b660de');
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('odellya' => array('elasticsearch_name' => 'odellya', 'reference' => $this->get('fos_elastica.index.odellya'), 'name' => 'odellya', 'settings' => array(), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('Application' => array('name' => 'Application', 'mapping' => array('dynamic_templates' => array(), 'properties' => array()), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'MainBundle\\Entity\\Application', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => false, 'query_builder_method' => 'createQueryBuilder'), 'identifier' => 'id', 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'finder' => array(), 'elastica_to_model_transformer' => array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array(), 'persister' => array()), 'serializer' => array('groups' => array(), 'serialize_null' => false), 'index_analyzer' => NULL, 'search_analyzer' => NULL, 'dynamic' => NULL, 'date_detection' => NULL, 'dynamic_date_formats' => array(), 'numeric_detection' => NULL)), 'Contact' => array('name' => 'Contact', 'mapping' => array('dynamic_templates' => array(), 'properties' => array()), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'MainBundle\\Entity\\Contact', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => false, 'query_builder_method' => 'createQueryBuilder'), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'identifier' => 'id', 'finder' => array(), 'elastica_to_model_transformer' => array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array(), 'persister' => array()), 'serializer' => array('groups' => array(), 'serialize_null' => false), 'index_analyzer' => NULL, 'search_analyzer' => NULL, 'dynamic' => NULL, 'date_detection' => NULL, 'dynamic_date_formats' => array(), 'numeric_detection' => NULL))))))));
    }
    ...
    {
        return $this->services['fos_elastica.provider.odellya.application'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.odellya.application'), $this->get('fos_elastica.indexable'), 'MainBundle\\Entity\\Application', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => false, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'odellya', 'typeName' => 'Application'), $this->get('doctrine'), $this->get('fos_elastica.slice_fetcher.orm'));
    }
    ...
    {
        return $this->services['fos_elastica.provider.odellya.contact'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.odellya.contact'), $this->get('fos_elastica.indexable'), 'MainBundle\\Entity\\Contact', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => false, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'odellya', 'typeName' => 'Contact'), $this->get('doctrine'), $this->get('fos_elastica.slice_fetcher.orm'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'AsseticBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'MainBundle', 9 => 'GregwarImageBundle', 10 => 'GregwarCaptchaBundle', 11 => 'JMSSerializerBundle', 12 => 'FOSElasticaBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a4b89e42f7219.39567256')), true);
