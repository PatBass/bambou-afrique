...
class Product extends \MainBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'title', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'price', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'available', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'updatedAt', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'categories', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'image', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'vat', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'dateAdded', '' . "\0" . 'MainBundle\\Entity\\Product' . "\0" . 'dateDeleted'];
        }
