...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Bamboudafrique-Casablanca')) {
            // index1
            ...
            // account
            if ($pathinfo === '/Bamboudafrique-Casablanca/Mon-compte') {
                return array (  '_controller' => 'MainBundle\\Controller\\MainController::accountAction',  '_route' => 'account',);
            }

            // single
            if ($pathinfo === '/Bamboudafrique-Casablanca/le-mets') {
                return array (  '_controller' => 'MainBundle\\Controller\\MainController::singleAction',  '_route' => 'single',);
            }

            // speciality
            if (0 === strpos($pathinfo, '/Bamboudafrique-Casablanca/Specialite') && preg_match('#^/Bamboudafrique\\-Casablanca/Specialite/(?P<category>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            // contact
            if ($pathinfo === '/Bamboudafrique-Casablanca/contact') {
        ...
        if (0 === strpos($pathinfo, '/Bamboudafrique-Casablanca')) {
            // login
            if ($pathinfo === '/Bamboudafrique-Casablanca/login') {
                return array (  '_controller' => 'MainBundle\\Controller\\MainController::loginAction',  '_route' => 'login',);
            }

            // checkout
            if ($pathinfo === '/Bamboudafrique-Casablanca/La-commande') {
                return array (  '_controller' => 'MainBundle\\Controller\\MainController::checkoutAction',  '_route' => 'checkout',);
            }

            // about
            if ($pathinfo === '/Bamboudafrique-Casablanca/A-propos-de-Bambou-d-Afrique') {
        ...
        // galery
        if ($pathinfo === '/Bamboudafrique-Casablanca/Galerie') {
            return array (  '_controller' => 'MainBundle\\Controller\\MainController::galeryaction',  '_route' => 'galery',);
        }
