...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'bambou', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/MainBundle/Entity'), 1 => ($this->targetDirs[3].'/src/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MainBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MainBundle' => 'MainBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ecae04bdcd2a194d5b1c59f336e93b3c253f9a5e265c09131258d70f929f47cb');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => '@FOSUser/Registration/email.txt.twig', 'resetting' => '@FOSUser/Resetting/email.txt.twig'), 'from_email' => array('confirmation' => array('contact@bamboudafrique.com' => 'contact@bamboudafrique.com'), 'resetting' => array('contact@bamboudafrique.com' => 'Restaurant Bambou d Afrique'))));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'bambou_user_registration', array(0 => 'CustomRegistration', 1 => 'Default'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $e, array(), $c);
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $h, $i, $e, 'main', $k, $l, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $d, $this->get('form.csrf_provider'));
        $m->setRememberMeServices($f);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $f, $h, $c, $d, true, $i), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a55021172f3f8.27884636', $c, $h), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($a, $b, $this->get('security.user_checker.main_login'), 'main', $this->get('security.access.decision_manager'), $c, '_switch_user', 'ROLE_ADMIN', $d), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $e, 'fos_user_security_login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('contact@bamboudafrique.com');
        $a->setPassword('bambou');
        $a->setAuthMode(NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'AsseticBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'MainBundle', 9 => 'GregwarImageBundle', 10 => 'GregwarCaptchaBundle', 11 => 'JMSSerializerBundle', 12 => 'FOSElasticaBundle', 13 => 'UserBundle', 14 => 'FOSUserBundle', 15 => 'DebugBundle', 16 => 'WebProfilerBundle', 17 => 'SensioDistributionBundle', 18 => 'SensioGeneratorBundle', 19 => 'CoreSphereConsoleBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|connexion|inscription|api)'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 8889,
            'database_name' => 'bambou',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'contact@bamboudafrique.com',
            'mailer_password' => 'bambou',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'contact@bamboudafrique.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'bambou',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'MainBundle',
                9 => 'GregwarImageBundle',
                10 => 'GregwarCaptchaBundle',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'contact@bamboudafrique.com' => 'contact@bamboudafrique.com',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'bambou_user_registration',
            'fos_user.registration.form.validation_groups' => array(
                0 => 'CustomRegistration',
                1 => 'Default',
            ),
            ...
            'fos_user.resetting.email.from_email' => array(
                'contact@bamboudafrique.com' => 'Restaurant Bambou d Afrique',
            ),
